            ...
            {({ open, close }) => (
              <>
                <Popover.Button
                  ...
                  className={`mt-3 sm:mt-auto rounded-full flex-col text-slate-700 dark:text-slate-300 w-10 h-10 sm:w-16 sm:h-16 focus:outline-none flex items-center justify-center ${isOpen && "text-blue-500"
                    }`}>
                  <div className="h-1">
                    <svg
