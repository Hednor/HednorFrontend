...
//           <div className="flex items-center justify-center gap-4 h-12 px-3 py-2 rounded-xl bg-slate-100">
...
//             <h1 className="font-medium">Refer</h1>
//           </div>
//         </div>
...
import { useRouter } from "next/navigation";
import Navigation from "@/shared/Navigation/Navigation"; // Make sure Navigation is imported
