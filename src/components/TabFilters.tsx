...
const TabFilters = () => {
        ...
        {({ open, close }) => (
          <>
            <Popover.Button
              ...
              <span className="lg:ml-1"> Sort : {sortOrderStates}</span>

              <ChevronDownIcon className="hidden lg:block size-4 ml-3" />
            </Popover.Button>
            <Transition
              as={Fragment}
              ...
              <Popover.Panel className="absolute z-50 w-56 px-4 mt-3 right-0 sm:px-0">
                <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700">
                  <div className="relative flex flex-col px-3 py-4 space-y-5">
  ...
  return (
    <div className="flex lg:space-x-4">
      {/* FOR DESKTOP */}
      <div className="hidden lg:flex flex-1 w-full mb-4 justify-between">
        <div
          className={`flex items-center justify-center px-4 py-2 text-sm border rounded-full focus:outline-none select-none`}>
      ...
      {/* FOR RESPONSIVE MOBILE */}
      <div className="flex lg:hidden space-x-2 py-2">
        <div> {renderTabMobileFilter()}</div>
